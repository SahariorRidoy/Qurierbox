...
const Location = () => {
  return (
    <div className="bg-[#FFF1DC] pt-20 lg:pt-48">
      <div className="max-w-[1320px] mx-auto ">
        ...
        <div className="flex justify-center pt-8">
            <button className="bg-primary btn-ghost rounded-md py-3 lg:py-6  px-2 lg:px-28 text-white flex items-center gap-3 lg:text-xl font-bold"><img src={call} alt="" />Call us to delivery  123-456789</button>
        </div>
